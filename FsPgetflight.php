...
if($_POST['FsPAskConnexion']=="yes")
{
    ...
    $result=@mysqli_query($db,$query);if(!$result){echo "#Answer# SQL Error - ".mysqli_error($db);return;}
...
if($_POST['FsPAskToRegister']=="yes")
{
    ...
    if(!@mysqli_query($db,$query)){echo "#Answer# SQL Error - ".mysqli_error($db);return;}
