...
{
	if(!@mysql_query("CREATE TABLE user_profile (
	...
	{
		$message="Unable to create table user_profile in this database mySql error: ".mysql_error();
	}
}
if($Ext_Table==1||$Ext_Table==3)
{
	if(!@mysql_query("CREATE TABLE flights (
			  id int(16) unsigned NOT NULL auto_increment,
	...
	{
		$message=$message.'Unable to create table flights in this database mySql error: '.mysql_error();
	}
}
