...
///////////////////// THIS IS THE LIST TABLE OUTPUT ///////////////////////////////////////////////////////////
    ...
    $result=@mysqli_query($db,$query);if(!$result){echo "SQL Error - ".mysqli_error($db);return;}
...
<html>
	...
	<body>
		...
		<a href="http://www.gcmap.com/mapui?PATH='.$dicao.'-'.$aicao.'&amp;MS=wls&amp;PM=b:diamond7%2b%22%25i%25+%28N%22"><img class="map" src="http://www.gcmap.com/map?P='.$dicao.'-'.$aicao.'&amp;MS=wls&amp;PM=b:diamond7%2b%22%25i%25+%28N%22" alt="Great Circle Route Map"></a>
